...
nkl_crystal = loadStructure("IMC.cif")
...
rou = 82./866.43 ## atomic density

g2 = g1 - 4*np.pi*rou*r1
plt.plot(r0, g0, "b-", lw=2, label = "PC")
plt.plot(r1, g1, "r-", lw=2, label = "DPC, rmax = 100 A")
plt.plot(r1, g2, "k-", lw=2, label = "DPC, minus 4*pi*rou*r")
...
plt.title("IMC cif PDF via PC and DPC")
plt.show()

np.savetxt("IMC_DPC_PDF", zip(r1, g2))
